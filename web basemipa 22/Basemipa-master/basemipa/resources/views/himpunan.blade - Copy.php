...
<div class="text-center">
    <h1>{{ $users->first()->himpunan }}</h1>
    <br>
</div>

<!-- Public Spreadsheet -->
<div class="text-right">
<span>Akses spreadsheet data Anggota Kema di sini</span>
<i class='fas fa-arrow-right'></i>
<a class="btn btn-success" href="https://docs.google.com/spreadsheets/d/1um-aEp7Fxoi_TRmJ2EoYFeJRrL6pmZUxgbUDAD8awis/edit?usp=sharing" role="button">Spreadsheet</a>
<br>
<br>
</div>
            ...
            <div class="card-body text-center p-4">
                <a href="javascript:0" data-toggle="modal" data-target="#modal-contact" class="text-secondary d-inline-block mb-3">
                    <div class="image mb-3 mt-n9">
                        <img style="height:197px; width:147px" src="https://media.unpad.ac.id/photo/mahasiswa/{{substr($user->username, 0, 6)}}/20{{substr($user->username, 6, 2)}}/{{$user->username}}.JPG" class="img-fluid rounded-circle" alt="Avatar Image">
                    </div>

                    <h5 class="card-title text-dark">{{ $user->name }}</h5>
                    <h6 class="card-title text-dark">{{ $user->username }}</h6>
                    <h6 class="card-title text-dark">ANGGOTA {{$user->member_status}}</h6>
                </a>
